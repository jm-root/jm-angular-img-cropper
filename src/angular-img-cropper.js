    ...
    return {
        ...
        link: function (scope, element) {
            ...
            var ImageCropper = (function () {
                function ImageCropper(canvas, x, y, width, height, keepAspect, touchRadius) {
                    ...
                    _binds = {
                        ...
                        canvas_mousedown:  this.onMouseDown.bind(this),
                        canvas_touchstart: this.onTouchStart.bind(this)
                    };

                    window.addEventListener('mousemove', _binds.mousemove);
                    window.addEventListener('mouseup', _binds.mouseup);
                    canvas.addEventListener('mousedown',_binds.canvas_mousedown);
                    window.addEventListener('touchmove', _binds.touchmove , false);
                    canvas.addEventListener('touchstart', _binds.canvas_touchstart, false);
                    window.addEventListener('touchend', _binds.touchend, false);
                }
            ...
            scope.$on('$destroy', function () {
                window.removeEventListener('mousemove', _binds.mousemove);
                window.removeEventListener('mouseup', _binds.mouseup);
                _binds.canvas.removeEventListener('mousedown',_binds.canvas_mousedown);
                window.removeEventListener('touchmove', _binds.touchmove , false);
                _binds.canvas.removeEventListener('touchstart', _binds.canvas_touchstart, false);
                window.removeEventListener('touchend', _binds.touchend, false);
            });
        }
    };
}]);
